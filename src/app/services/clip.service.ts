...
import { Router, ResolveFn, ActivatedRoute, RouterStateSnapshot, ActivatedRouteSnapshot } from '@angular/router';
...
export class ClipService {
  ...
  async getClips() {
    ...
    if (length) {
      ...
      const lastDocObs = await this.clipsCollection.doc(lastDocID).get()

      const lastDoc = await lastValueFrom(lastDocObs);
